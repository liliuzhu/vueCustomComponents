...
if (isBrowser) {
  window.__$vuxPopups = window.__$vuxPopups || {} // eslint-disable-line
}
...
popupDialog.prototype._bindEvents = function () { // eslint-disable-line
  if (this.params.hideOnBlur) {
...
popupDialog.prototype.show = function () {
  ...
  if (isBrowser) {
    window.__$vuxPopups[this.uuid] = 1  // eslint-disable-line
  }
}
...
popupDialog.prototype.hide = function (shouldCallback = true) {
  ...
  this.isShow = false
  if (isBrowser) {
    delete window.__$vuxPopups[this.uuid] // eslint-disable-line
  }
}
